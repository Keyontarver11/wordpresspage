...
define ( 'LIVEPORTFOLIO_VERSION', '1.0.3' );
...
function liveportfolio_defaults( $defaults ) {
	...
	$defaults['footer_text'] = '<a href="' . esc_url( __( 'http://wordpress.org/', 'live-portfolio' ) ) . '">' . __( 'Powered by WordPress', 'live-portfolio' ). '</a> | ' . __( 'theme ', 'live-portfolio' ) . '<a href="' .  esc_attr( __( '#', 'live-portfolio') ) . '">Live Portfolio</a>';
