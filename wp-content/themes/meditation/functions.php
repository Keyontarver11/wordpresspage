...
define ( 'MEDITATION_VERSION', '1.1.1' );
...
function meditation_get_defaults() {
	...
	$defaults = array(  'is_thumbnail_empty_icon' => '',
						...
						'footer_text' => '<a href="' . esc_url( __( 'http://wordpress.org/', 'meditation' ) ) . '">' . __( 'Powered by WordPress', 'meditation' ). '</a> | ' . __( 'theme ', 'meditation' ) . '<a href="' .  esc_url( __( '#', 'meditation') ) . '">Meditation</a>',
						'is_show_cat' => '1',
						/* customiser panels */
						'is_custom_colors' => '1',
						/* animation */
